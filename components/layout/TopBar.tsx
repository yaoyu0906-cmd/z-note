  ...
  return (
    <div className="flex items-center justify-between border-b border-line dark:border-lineDark bg-white dark:bg-surfaceDark px-3 py-2 gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 flex-1 max-w-md mx-auto text-left text-sm text-graphite dark:text-graphiteDark border border-line dark:border-lineDark rounded px-3 py-1.5 hover:border-accent"
      >
      ...
      <IconButton label="Profile">
        <span className="h-5 w-5 rounded-full bg-accentSoft dark:bg-accentSoftDark flex items-center justify-center text-[10px] text-accent">
          U
        </span>
      </IconButton>
    </div>
